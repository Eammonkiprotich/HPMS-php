...
<body>
    <div class="container">
        ...
        <form action="editdiagnosis.php?name=<?php if(empty($users)){ echo $user['username']; } else { echo $user['username'];} ?>" method="post">
            ...
            <div class="form-group">
                <label>Illness</label>
                <input class="form-control" name="illness" required type="text" value="<?php if($_SERVER['REQUEST_METHOD'] === 'GET' && $isGetandEmpty === 1){ echo ""; } else { echo $user['illness'];} ?>"></input>
            </div>
            <div class="form-group wrapper1">
            <?php if($_SERVER['REQUEST_METHOD'] === 'GET' && $isGetandEmpty === 1): ?>
                <div class="row">
                ...
                <?php endif; ?>
                <!-- issssssssssssssssuuuuuuuuuuuuuueeeeeeeeeeeeeeesssssssssssssss -->
                <?php if($_SERVER['REQUEST_METHOD'] === 'GET' && $isSet === 1): ?>
                    <div class="row">
                <label>Symptoms</label>
                <a href="javascript:void(0);" class="add_button_1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                ...
                <?php foreach(json_decode($user['symptoms']) as $key => $value): ?>
                            <?php echo "<div class=\"form-group\"><input class=\"form-control\" required name=\"symptoms[]\" type=\"text\" value=\"$value\"></input><a href=\"javascript:void(0)\" class=\"remove_button_1\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" fill=\"currentColor\" class=\"bi bi-dash\" viewBox=\"0 0 16 16\"><path d=\"M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z\"/></svg></a></div>"; ?>
                <?php endforeach; ?>
                <?php endif?>
                ...
                <a href="javascript:void(0);" class="add_button_2">
                    ...
                    <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                            ...
                            <?php  foreach(json_decode($user['treatment']) as $key => $value): ?>
                                <?php echo "<div class=\"form-group\"><small class=\"text-muted\">Treatment name</small><input class=\"form-control\" required name=\"treatment[]\" type=\"text\" value=\"$value\" required></input>"; ?>
                                    <?php foreach(json_decode($user['treatmentdesc']) as $key => $value): ?>
                                        <?php $obj = json_decode($user['treatmentdesc']); $temp = $obj[$index]; echo "<small class=\"text-muted\">Treatment description</small><input class=\"form-control\" required name=\"treatmentdesc[]\" type=\"text\" value=\"$temp\"></input><a href=\"javascript:void(0)\" class=\"remove_button_2\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" fill=\"currentColor\" class=\"bi bi-dash\" viewBox=\"0 0 16 16\"><path d=\"M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z\"/></svg></a></div>"; $index++; break;?>
                                    <?php endforeach; ?>
                            <?php endforeach; ?>
                <?php endif; ?>
        ...
        <div class="form-group wrapper3">
            ...
            <?php if($_SERVER['REQUEST_METHOD'] === 'GET' && $isSet === 1): ?>
                ...
                <?php $index = 0; ?>
                <?php if($user['drugname'] != null): ?>
                    <?php if(!empty($user['drugname'])): ?> 
                        <?php foreach(json_decode($user['drugname']) as $key => $value): ?>
                            <?php echo "<div class=\"form-group\"><small class=\"text-muted\">Drug name</small><input class=\"form-control\" required name=\"drugname[]\" type=\"text\" value=\"$value\"></input>"; ?>
                            <?php if($user['drugdosage'] != null): ?>
                                <?php if(!empty($user['drugdosage'])): ?>    
                                    <?php foreach(json_decode($user['drugdosage']) as $key => $value): ?>
                                        <?php $obj = json_decode($user['drugdosage']); $temp = $obj[$index]; echo "<small class=\"text-muted\">Dosage</small><input class=\"form-control\" required name=\"drugdosage[]\" type=\"text\" value=\"$temp\"></input><a href=\"javascript:void(0)\" class=\"remove_button_3\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" fill=\"currentColor\" class=\"bi bi-dash\" viewBox=\"0 0 16 16\"><path d=\"M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z\"/></svg></a></div>"; $index++; break;?>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if(empty($user['drugdosage']) || $user['drugdosage'] === null): ?>
                                <?php  echo "<small class=\"text-muted\">Dosage</small><input class=\"form-control\" required name=\"drugdosage[]\" type=\"text\" value=\"\"></input><a href=\"javascript:void(0)\" class=\"remove_button_3\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" fill=\"currentColor\" class=\"bi bi-dash\" viewBox=\"0 0 16 16\"><path d=\"M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z\"/></svg></a></div>"; ?>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    <?php endif; ?>
                <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="diagnosis" value="" required><?php if($_SERVER['REQUEST_METHOD'] === 'GET' && $isGetandEmpty === 1){ echo ""; } else { echo $user['diagnosis'];} ?></textarea>
            </div>
            <div class="form-group">
                <label>Medical Fee</label>
                <input class="form-control" name="fees" required type="number" step="0.01" value="<?php if($_SERVER['REQUEST_METHOD'] === 'GET' && $isGetandEmpty === 1){ echo "0"; } else { echo $user['fees'];} ?>"></input>
            </div>
            <br>
